    ...
    >
      ...
      <div className="mt-5 flex items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-2 font-mono text-[11px] font-bold tracking-[0.25em] uppercase text-ink/50">{m.role}</p>
        </div>
      ...
      <p className="mt-4 text-ink/75 font-medium leading-relaxed text-sm md:text-base">{m.bio}</p>
      ...
      <div className="mt-5 rounded-2xl bg-espresso px-4 py-3.5">
        <p className="font-mono text-[9px] tracking-[0.3em] uppercase text-mint mb-1.5">Sa commande</p>
        <p className="text-cream/85 font-medium text-sm leading-relaxed">{m.fun}</p>
      </div>
    </motion.article>
  );
}
  ...
  return (
    <>
      ...
      <PageHero
        n="☕"
        tag="L'équipe"
        title={<>Trois cofondateurs, <span className="text-mint-dark">un seul percolateur</span></>}
        subtitle="Stan, Pinoo et Flo : trois profils complémentaires qui partagent la même machine à café et la même obsession, des projets web qui rapportent vraiment à leurs clients."
      >
      ...
      <section className="bg-cream py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          ...
          >
            La brigade, <span className="squiggle">au complet</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            Pas de commerciaux qui disparaissent après signature, pas d'intermédiaires : vous parlez
            directement à ceux qui font le travail.
          </motion.p>
      ...
      <section className="bg-espresso py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          ...
          >
            ...
            >
              Voir tout ce qu'on sait faire <ArrowUpRight className="w-5 h-5" />
            </Link>
          </motion.div>
        </div>
      </section>
      ...
      <Edito
        kicker="Une équipe, pas une usine"
        title={<>Petite équipe, <span className="squiggle">grande attention</span></>}
        paragraphs={[
        ...
        links={[
          { to: "/notre-expertise", label: "Nos 12 expertises" },
          { to: "/#realisations", label: "Nos réalisations" },
        ]}
      />

      <CtaBand
        title="Venez rencontrer la brigade"
        sub="Premier échange autour d'un café, conseils francs, devis sans engagement."
